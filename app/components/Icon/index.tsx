...
import { faFootball, faHouse, faMusic, faUser, faChevronLeft, faChevronRight, faEnvelope, faFootballBall, faSun, faMoon, faRecordVinyl, faShare } from '@fortawesome/free-solid-svg-icons';
