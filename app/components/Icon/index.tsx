...
import { faFootball, faHouse, faMusic, faUser, faChevronLeft, faChevronRight, faEnvelope, faFootballBall, faSun, faMoon, faRecordVinyl, faShare, faPenToSquare, faTrashCan } from '@fortawesome/free-solid-svg-icons';
